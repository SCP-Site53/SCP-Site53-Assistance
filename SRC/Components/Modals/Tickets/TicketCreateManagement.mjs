...
export const data = { identity: 'ticket-create-management' };
export async function Execute({ interaction, database, settings }) {
    ...
    interaction.guild.channels.create({
        ...
        type: 0,
        parent: `Created by ${interaction.user.tag} (1023408869122256906)`,
        ...
        await database.set(`tickets.${ticket.id}`, {
                ...
                embeds: [
                    {
                        ...
                        description: `Thanks for reaching out, ${interaction.user}! However, management will not be able to respond immediately. Let us know if you have any more questions or concerns. We are always here to help you.\n\u200b`,
            ...
            embeds: [
                {
                    ...
                    title: `Welcome To Your Support Ticket!`,
                    author: { name: interaction.user.tag, iconURL: interaction.user.displayAvatarURL() },
                    description: `Thanks for reaching out, ${interaction.user}! However, management will not be able to respond immediately. Here is your support ticket, ${ticket}.\n\u200b`,
                    thumbnail: { url: interaction.guild.iconURL() },
                    fields: [
                        { name: `Topic`, value: `${topic}\n\u200b` },
                        { name: `Ticket Creator Identity`, value: `${interaction.user.id}\n\u200b`, inline: true },
