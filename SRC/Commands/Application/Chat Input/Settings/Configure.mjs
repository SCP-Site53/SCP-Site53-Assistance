    ...
    options: [
        {
            type: 2,
            name: 'staff',
            description: 'Configure something including staff.',
            default_permission: 'ADMINISTRATOR',
            options: [
                {
                    type: 1,
                    name: 'permissions',
                    description: 'Configure permissions for staff.'
                }
            ]
        },
    ]
...
export async function Execute({ interaction, database, settings }) {
    ...
    if (interaction.options.getSubcommand() === 'permissions') {
        ...
        const embed = {
            ...
            description: `Configure your staff permissions. All staff have access to non-staff commands.\n\u200b`,
            ...
            components: [
                {
                    ...
                    components: (
                        {
                            type: 3,
                            custom_id: 'configure_staff_role_permissions_options',
        ...
        const optionsCollector = interaction.channel.createMessageComponentCollector({
            filter: i => i.customId === 'configure_staff_role_permissions_options',
            componentType: 3,
            max: 1,
            time: 600000
        });
